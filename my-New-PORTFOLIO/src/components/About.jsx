...
import Aboutimage from './assets/Capture.jpg';
function About() {
    return (
                ...
                <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                    ...
                    <div className='flex-1'>
                        <p className='text-lg  mb-8'>
                            I am passionate Web-Developer with a facus on Building modern and
                            and responsive web applictions.With the a strong foundition in
